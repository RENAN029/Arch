...
sudo pacman -Rsnu --noconfirm gnome-extra gnome-user-docs gnome-music gnome-maps gnome-tour gnome-weather gnome-contacts yelp snapshot simple-scan epiphany htop vim
