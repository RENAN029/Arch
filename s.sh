...
sudo pacman -Rsnu --noconfirm gnome-extra gnome-user-docs gnome-music gnome-maps gnome-tour gnome-weather gnome-contacts gnome-calculator gnome-calendar yelp snapshot simple-scan epiphany htop vim
