...
sudo pacman -S --noconfirm hyprland hyprpaper hyprpicker kitty wofi waybar superfile earlyoom mplayer termusic gufw 7zip
sudo pacman -S --noconfirm nvidia-open intel-ucode git micro fastfetch btop fwupd flatpak yt-dlp aria2 hyprshot calcurse
sudo pacman -S --noconfirm lightdm-gtk-greeter xdg-user-dirs xdg-desktop-portal-hyprland hyprpolkitagent uwsm dunst feh
...
flatpak install -y flathub io.github.kolunmi.Bazaar app.zen_browser.zen org.onlyoffice.desktopeditors  
