...
sudo pacman -S --noconfirm hyprland hyprpaper hyprpicker hypridle speedtest-cli kitty waybar superfile hyprshot calcurse
sudo pacman -S --noconfirm nvidia-open intel-ucode git micro fastfetch btop ufw fwupd flatpak yt-dlp aria2 earlyoom rofi 
sudo pacman -S --noconfirm lightdm-gtk-greeter xdg-user-dirs xdg-desktop-portal-hyprland hyprpolkitagent uwsm swaync bc
