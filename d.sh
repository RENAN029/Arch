...
sudo pacman -S --noconfirm gdm nvidia-open intel-ucode git nano fastfetch btop gufw fwupd flatpak yt-dlp aria2 gamemode 

systemctl enable gdm gamemode
...
sudo pacman -S --noconfirm earlyoom ffpegthumbnailer
