...
echo "sudo pacman -S ffmpegthumbnailer iwd wireless_tools wpa_supplicant xdg-utils broadcom-wl bumblebee zerotier-one"
...
echo "==> https://library.hydra.wiki/library; https://github.com/psygreg/linuxtoys; https://github.com/imputnet/helium"
cd ..
rm -rf iwd
