...
sudo pacman -S --noconfirm cosmic-session cosmic-files cosmic-store cosmic-terminal xdg-user-dirs gnome-keyring iwd ncdu
sudo pacman -S --noconfirm nvidia-open intel-ucode nvim btop ufw fwupd flatpak yt-dlp aria2 earlyoom fastfetch git dconf
