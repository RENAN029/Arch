...
sudo pacman -S --noconfirm cosmic-session cosmic-files cosmic-store cosmic-terminal cosmic-text-editor gparted fastfetch  
sudo pacman -S --noconfirm nvidia-open intel-ucode git micro btop gufw fwupd flatpak yt-dlp aria2 earlyoom cosmic-player  
