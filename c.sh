...
sudo pacman -S --noconfirm cosmic-session cosmic-terminal cosmic-files cosmic-store xdg-user-dirs gnome-keyring tailscale
...
echo "sudo pacman -S nix yay ananicy-cpp clamav irqbalance pnpm mise cups mangohud gamescope distrobox docker httpie iwd"     
cd ..
rm -rf iwd
