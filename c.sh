...
sudo pacman -S --noconfirm cosmic-session cosmic-files cosmic-store cosmic-terminal cosmic-text-editor libqalculate fastfetch  
sudo pacman -S --noconfirm nvidia-open intel-ucode git helix btop ufw fwupd flatpak yt-dlp aria2 earlyoom cosmic-player  
